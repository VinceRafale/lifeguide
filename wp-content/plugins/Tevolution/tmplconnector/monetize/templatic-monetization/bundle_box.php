...
<div id="templatic_monetization" class="widget_div">
	...
	<div class="inside">
        ...
        <a href="<?php echo site_url(); ?>/wp-admin/admin.php?page=monetization"><h3 class="hndle"><span><?php _e('Monetization',DOMAIN); ?></span></h3></a>
		...
		<div id="publishing-action" class="settings_style">
			<a title="<?php _e('Settings',DOMAIN); ?>" id="WpEcoWorld_monetization" class="templatic-tooltip set_lnk" href="<?php echo site_url()."/wp-admin/admin.php?page=monetization";?>"><i class="fa fa-gear"></i></a>
			<a href="<?php echo site_url()."/wp-admin/admin.php?page=templatic_system_menu&deactivate=monetization&true=0";?>" class="button"><i class="fa fa-times"></i>&nbsp;<?php _e('Deactivate',DOMAIN); ?></a> 
	...
	<?php } else { ?>
		<div id="publishing-action" class="settings_style">
		<a href="<?php echo site_url()."/wp-admin/admin.php?page=templatic_system_menu&activated=monetization&true=1";?>" class="button-primary"><i class="fa fa-check"></i>&nbsp;<?php _e('Activate &rarr;',DOMAIN); ?></a></div>
	<?php } ?>
	</div>
</div>
<?php 
