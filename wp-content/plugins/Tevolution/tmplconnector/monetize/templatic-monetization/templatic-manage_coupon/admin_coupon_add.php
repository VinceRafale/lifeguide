	...
	<p class="description"><?php _e($custom_msg,DOMAIN);?></p>
     ...
     <table style="width:65%" cellpadding="3" cellspacing="3" class="form-table" id="form_table_coupon" >
          <tr id="startdate1">
               ...
               <td>              
               	<input type="text" class="" name="startdate" id="startdate" class="textfield"  value="<?php echo get_post_meta($post_id,"startdate",true); ?>" size="25"  placeholder="<?php _e('Start Date',DOMAIN); ?>"/> &nbsp;&nbsp;              
				<input type="text" class="" name="enddate" id="enddate" class="textfield"  value="<?php echo get_post_meta($post_id,"enddate",true); ?>" size="25"  placeholder="<?php _e('End Date',DOMAIN); ?>"/>
          ...
          <tr id="couponcode1">
               ...
               <td colspan="3">
               	<input type="text" class="regular-text" autocomplete="off"  name="couponcode" id="couponcode" value="<?php if(isset($post_val->post_title))echo $post_val->post_title; ?>" onkeyup="chkcoupon();" placeholder='<?php _e('Coupon Code',DOMAIN); ?>'><p class="description"><?php _e('It will act as a coupon verification key on your site.(Not restricted to any character limit)',DOMAIN)?></p>
               </td>
          ...
          <tr>
               ...
               <td colspan="3">
                    ...
                    <?php _e('Percentage',DOMAIN);?>(%)</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="coupondiscamt"><input type="radio" id="coupondiscamt" name="coupondisc" <?php if(get_post_meta($post_id,"coupondisc",true) == 'amt'){?> checked="checked"<?php }?> value="amt" /> <?php _e('Amount',DOMAIN);?></label>
          ...
          <tr id="save_coupon" >
          	<td colspan="4"><input type="submit" class="button-primary" name="save_coupon" onclick="return check_frm();" id="save" value="<?php _e('Save all changes',DOMAIN);?>" />
          </td>
          </tr>
     </table>
</form>
