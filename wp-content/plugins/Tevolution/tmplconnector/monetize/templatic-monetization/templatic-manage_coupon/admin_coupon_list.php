...
?>
<div class="wrap">
<div class="tevo_sub_title"><?php _e('Manage Coupons',DOMAIN);?>  
...
<p class="tevolution_desc"><?php _e('This section lets you display and add coupons on your website as a part of the publicity or offers with the option of defining its validity period.',DOMAIN);?></p>
<?php
