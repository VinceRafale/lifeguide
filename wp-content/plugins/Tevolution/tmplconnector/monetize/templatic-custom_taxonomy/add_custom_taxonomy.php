...
<form action="<?php echo site_url();?>/wp-admin/admin.php?page=custom_taxonomy&action=add_taxonomy" method="post" name="custom_taxonomy" onsubmit="return check_taxonomy_form();" >
     <table class="form-table" id="form_table_taxonomy">
          <thead>
               <tr colspan="3">                   
                         ...
                         <?php _e('Fill up the necessary information to create a new post type and matching taxonomies. Starred <span class="required">*</span> fields are compulsory, so you cannot leave them blank. These custom post will appear as one of the option in wp-admin (dashboard) menu panel. <br><strong> Note: </strong>Be careful while adding slugs, It will appear in the URL and you will not be able to edit them once you save taxonomy.',DOMAIN); ?>
                         </p>
               </tr>
          </thead>
          <tbody>
               <tr class="" id="post_title">
                    <th valign="top">
                    	<label for="post_name" class="form-textfield-label"><?php _e('Post Type Name',DOMAIN); ?> <span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('e.g. Places, Events etc',DOMAIN); ?>.</p>
                    </td>
               </tr>
               <tr class="" id="post_title_slug">
                    <th valign="top">
                    	<label for="post_slug" class="form-textfield-label"><?php _e('Post Type Slug',DOMAIN); ?> <span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('e.g. places, events etc',DOMAIN); ?>.<strong> <?php _e('Note',DOMAIN); ?>: </strong><?php _e('Just enter small letters without any space.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr class="" id="tax_name">
                    <th valign="top">
                    	<label for="taxonomy_name" class="form-textfield-label"><?php _e('Custom Taxonomy name',DOMAIN); ?><span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('e.g. Categories, Event Categories etc.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr class="" id="tax_slug">
                    <th valign="top">
                    	<label for="taxonomy_slug" class="textfield-label"><?php _e('Taxonomy Slug ',DOMAIN); ?> <span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         <input type="text" class="regular-text"  <?php if($edit_post) { ?>readonly="readonly" <?php } ?> value="<?php if($edit_post) { echo $edit_post[@$_REQUEST['post-type']]['slugs'][0]; } ?>" name="taxonomy_slug" id="taxonomy_slug">                         <p class="description"><?php _e('e.g. eventcategories, placecategories etc',DOMAIN); ?>.<strong> <?php _e('Note',DOMAIN); ?>: </strong><?php _e('Just enter small letters without any space.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr class="" id="tag_title">
                    <th valign="top">
                    	<label for="tag_name" class="textfield-label"><?php _e('Custom Tag name',DOMAIN); ?><span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('e.g. Tags, Events Tags etc.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr class="" id="tag_slug_name">
                    <th valign="top">
                    	<label for="tag_slug" class="textfield-label"><?php _e('Tags Slug',DOMAIN); ?> <span class="required"><?php echo FLD_REQUIRED_TEXT; ?></span></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('e.g. etags, placetags etc',DOMAIN); ?>.<strong> <?php _e('Note',DOMAIN); ?>: </strong><?php _e('Just enter small letters without any space.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr>
              		<th valign="top">
                    	<label for="description" class="form-textarea-label"><?php _e('Description',DOMAIN) ;?></label>
                    </th>
                    <td>
                    ...
                    <p class="description"><?php _e('Explain the purpose of this custom post type in few words.',DOMAIN); ?></p>
                    </td>
               </tr>
			   <?php
				global $tevolutions_icon ;
				
			   if(@$_REQUEST['post-type'] =='' && !in_array(@$_REQUEST['post-type'],$tevolutions_icon)){
			   ?>
               <tr>
                    <th valign="top">
                    	<label for="upload_image" class="form-textarea-label"><?php _e('Upload Icon',DOMAIN) ;?></label>
                    </th>
                    <td>
                         <input id="upload_image" type="text" size="36" name="upload_image" value="<?php if($edit_post) { echo $edit_post[@$_REQUEST['post-type']]['menu_icon']; } ?>" /> <?php _e('Or',DOMAIN);?>
                         <input id="upload_image_button" type="button" value="Upload Image"  class="button upload_button"/>                         
                         <p class="description"><?php _e('Enter the URL or upload an image of 16 x 16 pixels for the custom post type icon and click on "Insert into post" button',DOMAIN); ?>.</p>
                    </td>
               </tr>
			   <?php } 
     ...
     <table class="form-table" >
          <thead>
               <tr>
               	<th colspan="3"><div class="tevo_sub_title"><?php _e('Labels For Taxonomy Section',DOMAIN); ?></div><p class="tevolution_desc"><?php _e('Specify the labels (basically names) for your custom post type. These labels are used for your custom post type which indicates certain action like add new listing, category (helps in grouping your posts), tags etc. They will appear under your post type section on your wp-admin panel.',DOMAIN)?></p></th>
               </tr>
          </thead>
          <tbody>
               <tr>
                    ...
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed on Add new item links. By default it will display Add New for all the post types.',DOMAIN); ?></p>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    	<label for="add_new_item" class="form-textfield-label"><?php _e('Add New Item',DOMAIN); ?></label>
                    </th>
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed on the post detail page while adding a post. By default it will display New Item.',DOMAIN); ?></p></div>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    ...
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed on the post detail page while editing a post. By default it will display Edit Item.',DOMAIN); ?></p></div>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    ...
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed on the post detail page after you submit the post. By default it will display View Item.',DOMAIN); ?></p></div>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    ...
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed on the Search button. By default it will display Search Items.',DOMAIN); ?></p></div>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    ...
                    <td>
                         ...
                         <p class="description"><?php _e('Will be displayed when there is no item in Posts or Pages. By default it will display No posts found/No pages found.',DOMAIN); ?></p></div>
                    </td>
               </tr>
               <tr>
                    <th valign="top">
                    ...
                    <td>
                        ...
                        <p class="description"><?php _e('Will be displayed when there is no item in Trash. By default it will display No posts found in Trash/No pages found in Trash.',DOMAIN); ?></p></div>
                    </td>
               </tr>
          </tbody>
     </table>
    <input type="submit" class="button-primary form-submit form-submit submit" value="<?php _e('Save Taxonomy',DOMAIN); ?>" name="submit-taxonomy" id="submit-1">
</form>
</div>
<?php
