...
class templatic_aboust_us extends WP_Widget {
	...
	//Constructor
		$widget_ops = array('classname' => 'widget Templatic About Us', 'description' => __('Use this widget to show some basic information about your website or company. HTML tags are allowed. Works best in sidebar areas.',DOMAIN),'before_widget'=>'<div class="column_wrap">' );
		$this->WP_Widget('templatic_aboust_us', __('T &rarr; About Us',DOMAIN), $widget_ops);
	}
	...
	//widgetform in backend
		...
		$title = ($instance['title']) ? $instance['title'] : __("About Templatic",DOMAIN);
		$about_us = ($instance['about_us']) ? $instance['about_us'] : __("Templatic is five year old company which specilizes in creating beautiful app-like WordPress themes. Our themes are known for their stunning design and powerful features which provide a unique experience for visitors to the tens of thousands of websites we have helped create. Your dream site is literally just a few clicks away!",DOMAIN) ;
	?>
	<p>
	...
	<p>	  
    	<label for="<?php echo $this->get_field_id('about_us'); ?>"><?php _e('Description:',DOMAIN);?>
