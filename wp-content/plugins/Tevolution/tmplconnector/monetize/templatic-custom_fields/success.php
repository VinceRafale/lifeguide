...
if($amout=='0' || $amout==''){
	...
	{
		$get_last_trans_status = $wpdb->get_var("select status from $transaction_tabel where post_id=".$_SESSION['custom_fields']['user_last_postid']);
	...
	{
		if($tmpdata['post_default_status']=='publish' && !isset($_SESSION['custom_fields']['last_selected_pkg']) && $_SESSION['custom_fields']['last_selected_pkg'] == ''){
