...
if($activated){
templatic_module_activationmsg('custom_fields_templates','Custom Fields Manager','',$mod_message=__('In order to use this feature, you can create the custom fields',DOMAIN).' <a href='.admin_url('/admin.php?page=custom_fields').'>'.__('here',DOMAIN).'</a>.',$realted_mod =''); 
}else{
...
<div id="templatic_customfields" class="widget_div">
    ...
    <div class="inside">
        ...
        <a href="<?php echo site_url(); ?>/wp-admin/admin.php?page=custom_fields"><h3 class="hndle"><span><?php _e('Custom Fields Manager',DOMAIN); ?></span></h3></a>
		...
		<a href="<?php echo site_url()."/wp-admin/admin.php?page=templatic_system_menu&activated=custom_fields_templates&true=1";?>" class="button-primary"><i class="fa fa-check"></i><?php _e('Activate &rarr;',DOMAIN); ?></a></div>
		<?php } 
		...
		<a href="<?php echo site_url()."/wp-admin/admin.php?page=templatic_system_menu&deactivate=custom_fields_templates&true=0";?>" class="button"><i class="fa fa-times"></i>&nbsp;<?php _e('Deactivate ',DOMAIN); ?></a>
