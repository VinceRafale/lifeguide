<div id="claim_listing" class="templ_popup_forms clearfixb" style="display:none;">
	...
	<form name="claim_listing_frm" id="claim_listing_frm" action="<?php echo the_permalink($post->ID); ?>" method="post">
		...
		<div id="claim-header" class="claim-header">
			<h3 class="h3"><?php echo sprintf(__('Do you own this %s',DOMAIN),$post->post_type); ?></h3>
		...
		<div class="form_row clearfix"><label><?php _e('Your Claim',DOMAIN);?><span>*</span></label> <textarea name="claim_msg" id="claim_msg" cols="10" rows="5" ><?php _e('Hello, I would like to notify you that I am the owner of this listing. I would like to verify it&lsquo;s authenticity.',DOMAIN); ?></textarea><span id="claim_msgInfo"></span></div>
