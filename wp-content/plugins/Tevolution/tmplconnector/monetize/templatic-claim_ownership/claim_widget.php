...
class claim_widget extends WP_Widget
{
	...
	function widget($args, $instance)
	{
		...
		if(is_array($post_type) && in_array($ptype,$post_type)):
			...
			if(!isset($_REQUEST['pid']) && $_REQUEST['pid']== '')
				_e('To enable claim ownership functionality for this post type go to wp-admin &rsaquo;&rsaquo; Tevolution &rsaquo;&rsaquo; General Settings &rsaquo;&rsaquo; Claim ownership settings',DOMAIN);		
		endif;
				echo $after_widget;
	}
