...
<div class="wrap">
     <div id="icon-edit" class="icon32 icon32-posts-post"><br/></div>
    	<h2>
		<?php _e('Manage user profile fields',DOMAIN);?>  
      ...
      <p class="tevolution_desc"><?php _e('The fields you add/edit here will be displayed in user&rsquo;s dashboard and profile area. Using these fields, you can make users fill in custom information about themselves from the registration page you create.',DOMAIN);?></p>
