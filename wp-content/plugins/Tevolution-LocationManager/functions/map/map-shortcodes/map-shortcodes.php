...
if(file_exists(TEVOLUTION_LOCATION_DIR.'functions/map/map-shortcodes/current_city_map_shortcode.php')){
		include(TEVOLUTION_LOCATION_DIR.'functions/map/map-shortcodes/current_city_map_shortcode.php');
}
...
?>
    ...
    <div class="entry"> 
		...
		<?php if($address!=""):?>
          <li class='pinpoint'><a id="pinpoint_<?php echo $post->ID;?>" class="ping" href="#map_canvas"><?php _e('Pinpoint',LM_DOMAIN);?></a></li>               
		<?php endif;?>
		<?php
		echo '</ul>';
		echo '</div>';
