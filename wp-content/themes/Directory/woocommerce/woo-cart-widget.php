...
if(!class_exists('templatic_woo_shopping_cart_info')){
	class templatic_woo_shopping_cart_info extends WP_Widget {
		...
		function templatic_woo_shopping_cart_info() {
			...
			//Constructor
			$widget_ops = array('classname' => 'widget WooCommerce shopping cart info', 'description' => __('Display Cart Informations with automatic cart update. Best to use it in "Header right area" widget are',THEME_DOMAIN));
