...
<div class="loop-meta">
  ...
  <?php
	...
	?>
    <p><?php printf( __( 'You are browsing the search results for "<strong>%s</strong>" <span>%s</span>', THEME_DOMAIN ), esc_attr( get_search_query() ) , $radius ); ?></p>
  </div>
  <!-- .loop-description -->
</div>
<!-- .loop-meta -->
...
<div class="loop-meta">
  <?php if ( is_day() ) : ?>
  <h1 class="loop-title"><?php printf( __( 'Daily Archives: %s', THEME_DOMAIN ), '<span>' . get_the_date() . '</span>' );?></h1>
  <div class="loop-description">
    <p><?php printf( __( 'You are browsing the site archives by %s.', THEME_DOMAIN ), '<span>' . get_the_date() . '</span>'); ?></p>
  </div>
  <!-- .loop-description -->
  <?php elseif ( is_month() ) :?>
  <h1 class="loop-title"><?php printf( __( 'Monthly Archives: %s', THEME_DOMAIN ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', THEME_DOMAIN ) ) . '</span>' );?></h1>
  <div class="loop-description">
    <p><?php printf( __( 'You are browsing the site archives by %s.', THEME_DOMAIN ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', THEME_DOMAIN ) ) . '</span>' ); ?></p>
  </div>
  <!-- .loop-description -->
  <?php elseif ( is_year() ) :?>
  <h1 class="loop-title"><?php printf( __( 'Yearly Archives: %s', THEME_DOMAIN ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', THEME_DOMAIN ) ) . '</span>' );?></h1>
  <div class="loop-description">
    <p><?php printf( __( 'You are browsing the site archives by %s.', THEME_DOMAIN ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', THEME_DOMAIN ) ) . '</span>'  ); ?></p>
  </div>
  <!-- .loop-description -->
  <?php endif;?>
</div>
