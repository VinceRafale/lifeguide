...
class supreme_facebook extends WP_Widget {
	function supreme_facebook() {
		//Constructor
		$widget_ops = array('classname' => 'widget Templatic facebook fans t_facebook_fans', 'description' => __('Display a like box for your Facebook page. Works best in sidebar areas.',THEME_DOMAIN) );
		$this->WP_Widget('supreme_facebook', __('T &rarr; Facebook Like Box',THEME_DOMAIN), $widget_ops);
	}
...
<p>
  <label for="<?php echo $this->get_field_id('facebook_page_url'); ?>">
    <?php  _e('Facebook Page Full URL',THEME_DOMAIN)?>
    :
...
<p>
  <label for="<?php echo $this->get_field_id('show_faces'); ?>">
    <?php  _e('Show Faces',THEME_DOMAIN)?>
    :
...
<p>
  <label for="<?php echo $this->get_field_id('show_stream'); ?>">
    <?php  _e('Show Stream',THEME_DOMAIN)?>
    :
...
<p id="facebook_show_header" <?php if(esc_attr($show_stream)=='1' || esc_attr($show_faces)=='1'){echo "style='display:block;'";}else{echo "style='display:none;'";}?>>
  <label for="<?php echo $this->get_field_id('show_header'); ?>">
    <?php  _e('Show Header',THEME_DOMAIN)?>
    :
