...
<p>
  ...
  <?php } else { ?>
  <?php _e( 'No templates exist for this post type.', THEME_DOMAIN ); ?>
  <?php } ?>
</p>
<?php
}
...
<p>
  <label for="supreme-document-title">
    <?php _e( 'Document Title', THEME_DOMAIN ); echo ": "; ?>
  </label>
  <br />
...
<p>
  <label for="supreme-meta-description">
    <?php _e( 'Meta Description', THEME_DOMAIN ); echo ": "; ?>
  </label>
  <br />
...
<p>
  <label for="supreme-meta-keywords">
    <?php _e( 'Meta Keywords', THEME_DOMAIN ); echo ": "; ?>
  </label>
  <br />
