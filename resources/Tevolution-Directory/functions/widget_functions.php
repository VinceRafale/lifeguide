	...
	function widget($args, $instance) {
		...
		if($show_list){
			...
			if($latest_menus):
				...
				echo sprintf(__('Sorry! No near by results found.',DOMAIN));
			endif;
		}		
	...
	function widget($args, $instance) {
		...
		<form method="get" id="searchform" action="<?php echo home_url(); ?>/">
          	...
          	<input type="hidden" name="nearby" value="search" />
               ...
               <input type="text" name="location" id="location" class="location" onfocus="if (this.placeholder == '<?php echo _e('Where?',DOMAIN);?>') {this.placeholder = '';}" onblur="if (this.placeholder == '') {this.placeholder = '<?php _e('Where?',DOMAIN);?>';}" value="<?php echo $location; ?>"  placeholder="<?php _e('Where?',DOMAIN);?>"/>
               ...
               <input type="submit" class="sgo" onclick="find_click();" value="<?php echo 'Buscar'  /* _e('Search',DOMAIN); */?>" />
          </form>
		<script type="text/javascript">
			function find_click()
			{
